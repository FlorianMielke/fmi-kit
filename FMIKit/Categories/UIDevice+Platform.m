...
- (NSString *)platform
{
    ...
    if ([platform isEqualToString:@"iPad4,7"])      return @"iPad mini 3G (Wi-Fi)";
    if ([platform isEqualToString:@"iPad4,8"])      return @"iPad mini 3G (Cellular)";
    if ([platform isEqualToString:@"iPad4,9"])      return @"iPad mini 3G (Cellular)";

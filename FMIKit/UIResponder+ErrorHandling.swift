extension UIResponder {
    @objc open func handle(_ error: NSError, from viewController: UIViewController, retryHandler: (() -> Void)?, cancelHandler: (() -> Void)?) {
        ...
        nextResponder.handle(error, from: viewController, retryHandler: retryHandler, cancelHandler: cancelHandler)
    }
}
